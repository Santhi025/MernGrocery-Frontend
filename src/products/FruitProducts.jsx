...
const FruitProducts = () => {
  ...
  // SEARCH FILTER 
  const filteredFruits = fruits.filter((product) =>
  ...
  return (
    <div>
      {/* <div className="itemTitle">
        Category: <span>Fresh Fruits</span>
      </div> */}
      ...
      <div className="productSection">
        ...
        {!loading && filteredFruits.length === 0 && (
          <h2 className="emptyState">
            {search ? "No matching fruits found 🔍" : "No fruits found 😕"}
          </h2>
        )}

        {/* PRODUCTS */}
        {!loading && filteredFruits.map((product) => (
